create table classroom (building str unique, room_number str, capacity int);
...
create table teaches (ID str unique, course_id str, sec_id str, semester str, year int);
